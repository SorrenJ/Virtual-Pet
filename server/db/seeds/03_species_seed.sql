...
('Vulinquent', 10, 6, 4, 8, 300, 1, 'Vulinquent are devious manipulators, enjoying the torment of others. They often use their nose to find their prey, as their ears are too occupied listening to rock music. They tend to go in groups, heading to the next concert. If you see a Vulinquent, run.',);
